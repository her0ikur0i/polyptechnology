...
| --------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Anonymous dashboard control | Cloudflare Access plus origin JWT validation (interim: enforced loopback-only bind for `ACCESS_AUTH_MODE=cloudflare`, `src/config.ts` -- see CONTRACT-013 M8 evidence; JWT validation remains a documented future step, not yet implemented) |
