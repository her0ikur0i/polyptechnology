...
**Active contract: CONTRACT-017C** — 6 of 7 milestones evidenced, generated 2026-08-11.
...
| M6        | the full drill run clean from a standing start; spend reported; README, security review, close   | **next**                                 |

- **HEAD:** `cc2dd34 CONTRACT-017C: make the generation pipeline actually run`
- **Working tree:** 13 changed path(s) — expected while a contract is in flight, since this repository commits once per contract
- **Last touched:** `docs/contracts/CONTRACT-017C/evidence/M5-first-generated-project.md` at 2026-08-11T13:02Z — if a session ended abruptly, work was here
- **Next action:** M6 — the full drill run clean from a standing start; spend reported; README, security review, close
