...
**Active contract: CONTRACT-018** — 6 of 8 milestones evidenced, generated 2026-08-13.

| Milestone | Subject                                                                 | State                                    |
| --------- | ----------------------------------------------------------------------- | ---------------------------------------- |
| M0        | owner confirmation                                                      | done — `M0-owner-confirmation.md`        |
| M1        | Control API SSE route, resuming from a last-ordinal cursor              | done — `M1-deepseek-ui-extreme-drill.md` |
| M2        | the client consumes it and renders progressively, including reconnect   | done — `M2-progressive-reply-stream.md`  |
| M3        | markdown and code rendering, proven non-injecting against hostile input | done — `M3-safe-markdown-rendering.md`   |
| M4        | the composer                                                            | done — `M4-composer-controls.md`         |
| M5        | per-message model attribution and cost from the ledger                  | done — `M5-message-attribution.md`       |
| M6        | virtualized thread rendering                                            | **next**                                 |
| M7        | live drill in the real dashboard, README, security review, close        | not started                              |

- **HEAD:** `07edccd Add reusable remove AI marks skill`
- **Working tree:** 31 changed path(s) — expected while a contract is in flight, since this repository commits once per contract
- **Last touched:** `docs/contracts/CONTRACT-018/contract.md` at 2026-08-13T12:28Z — if a session ended abruptly, work was here
- **Next action:** M6 — virtualized thread rendering
