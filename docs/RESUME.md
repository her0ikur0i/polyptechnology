...
**Active contract: CONTRACT-017B** — 6 of 6 milestones evidenced, generated 2026-08-11.

| Milestone | Subject                                                                      | State                                          |
| --------- | ---------------------------------------------------------------------------- | ---------------------------------------------- |
| M0        | owner confirmation, recorded above                                           | done — `M0-owner-confirmation.md`              |
| M1        | exponential retry backoff, replacing the flat delay                          | done — `M1-retry-backoff.md`                   |
| M2        | truthful failure reporting                                                   | done — `M2-truthful-failures.md`               |
| M3        | one budget calculation shared by every surface that shows spend              | done — `M3-one-budget-calculation.md`          |
...
Under the standing zero-skip invocation the suite reports **351 tests, 351
passing, 0 skipped** (2026-08-11). Up from 332 at CONTRACT-017's close: +5
`retry-backoff`, +8 `report-consistency`, +6 in `run-notifier`. A different
number means something changed — account for the difference rather than letting
it pass, and state the invocation alongside any count you report.
