...
**Active contract: CONTRACT-018** — 5 of 8 milestones evidenced, generated 2026-08-13.
...
| M5        | per-message model attribution and cost from the ledger                  | **next**                                 |
| M6        | virtualized thread rendering                                            | not started                              |
| M7        | live drill in the real dashboard, README, security review, close        | not started                              |

- **HEAD:** `d08f74a CONTRACT-018 M3: render safe markdown`
- **Working tree:** 9 changed path(s) — expected while a contract is in flight, since this repository commits once per contract
- **Last touched:** `docs/contracts/CONTRACT-018/evidence/M4-composer-controls.md` at 2026-08-13T11:40Z — if a session ended abruptly, work was here
- **Next action:** M5 — per-message model attribution and cost from the ledger
