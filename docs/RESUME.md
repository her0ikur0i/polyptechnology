...
**Active contract: CONTRACT-018** — 4 of 8 milestones evidenced, generated 2026-08-13.
...
- **HEAD:** `6e14dc0 CONTRACT-018 M2: stream conversation replies`
- **Working tree:** 12 changed path(s) — expected while a contract is in flight, since this repository commits once per contract
- **Last touched:** `docs/contracts/CONTRACT-018/evidence/M3-safe-markdown-rendering.md` at 2026-08-13T11:22Z — if a session ended abruptly, work was here
- **Next action:** M4 — the composer
