...
<!-- resume:contract: CONTRACT-017C -->
<!-- resume:auto:start -->

<!-- Generated by scripts/resume-checkpoint.ts. Do not hand-edit: run it. -->

**Active contract: CONTRACT-017C** — 5 of 7 milestones evidenced, generated 2026-08-11.

| Milestone | Subject                                                                                          | State                                    |
| --------- | ------------------------------------------------------------------------------------------------ | ---------------------------------------- |
| M0        | owner confirmation, recorded above                                                               | done — `M0-owner-confirmation.md`        |
| M1        | read the pipeline end to end and write down where it is expected to break, before running it. A… | done — `M1-predicted-failures.md`        |
| M2        | the drill script, driving conversation → proposal → approval                                     | done — `M2-drill-and-first-blueprint.md` |
| M3        | blueprint → workspace provisioning, against staging                                              | done — `M3-provisioning-and-fixes.md`    |
| M4        | generation task → patch execution in an isolated worker                                          | done — `M4-generation-and-escalation.md` |
| M5        | verification gates → publication, reaching a terminal successful state                           | **next**                                 |
| M6        | the full drill run clean from a standing start; spend reported; README, security review, close   | not started                              |

- **HEAD:** `913a516 docs: mark CONTRACT-017A closed and point the next session at CONTRACT-018`
- **Working tree:** 39 changed path(s) — expected while a contract is in flight, since this repository commits once per contract
- **Last touched:** `docs/contracts/CONTRACT-017C/evidence/M4-generation-and-escalation.md` at 2026-08-11T11:44Z — if a session ended abruptly, work was here
- **Next action:** M5 — verification gates → publication, reaching a terminal successful state
